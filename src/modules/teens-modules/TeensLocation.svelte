...
<section class="location-section container">
  <h2>Филиалы нашей Академии</h2>
  <div class="location-container">
    <div class="location-block">
      <img class="location-image" src="./assets/images/place-1.png" alt="location" />
      <h5 class="title">CODIFY Академия в 7 микрорайоне</h5>
      ...
      <div class="location-info_box">
        ...
        <p>г. Бишкек, 7 микрорайон, 23</p>
      </div>
      <a
        href="https://2gis.kg/bishkek/branches/70000001038163167/firm/70000001063954838?m=74.617117%2C42.828746%2F17.62"
        target="_blank"
      >
        <button class="button contained"> Смотреть на карте </button>
      </a>
    </div>
    <div class="location-block">
      ...
      <div class="location-info_box">
        <img src="./assets/icons/new-location.svg" alt="location" />
        <p>г. Бишкек, Ибраимова 115, БЦ Асыл-Таш</p>
      </div>
      <a href="https://go.2gis.com/u44oz" target="_blank">
        <button class="button contained"> Смотреть на карте </button>
      </a>
    </div>
  </div>
