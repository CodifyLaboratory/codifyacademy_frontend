<script>
  ...
  language.subscribe(async lang => {
    ...
    if (id) {
      axios
        .get(`http://178.62.241.156/${activeLang}/api/courses/${id}`)
        .then(({ data }) => {
          course = data
        })
        .catch(error => {
...
<svelte:head>
  ...
  />
  <meta property="og:image" content="http://178.62.241.156/first-image.jpg" />
  <meta property="og:image:alt" content="title image of site" />
  <meta http-equiv="Content-Security-Policy" content="upgrade-insecure-requests" />
  <meta property="og:image:width" content="1024" />
  <meta property="og:image:height" content="1024" />
  <meta property="og:site_name" content="codify.home.uz" />
  <meta property="og:locale" content="ru_RU" />
  <meta property="og:type" content="website" />
  <meta property="og:image:secure_url" content="http://178.62.241.156/first-image.jpg" />
  ...
  <meta
    ...
    content="Курсы программирования в Ташкенте. Обучись актуальной профессии и начни зарабатывать"
  />
  <meta property="twitter:image" content="http://178.62.241.156/first-image.jpg" />
