...
<div class="olympiad modal-card">
  <h3>Олимпиада для студентов CODIFY Kids</h3>
  <b
    >Хотите испытать свои навыки программирования на деле? Принять участие в увлекательном соревновании? Тогда добро
    пожаловать на нашу олимпиаду по программированию!</b
  >
  <p>
    Это событие создано специально для студентов курсов программирования CODIFY Kids. Здесь вы сможете
    продемонстрировать свои знания, умения и креативность в программировании.
  </p>
  <p>
    Не упустите шанс стать частью этого захватывающего события! Запишитесь на курсы программирования CODIFY Kids уже
    сегодня и присоединяйтесь к олимпиаде. Давайте вместе создадим что-то удивительное 🚀
  </p>

  <p>
    ⚡️ Для детей с 7 до 11 лет<br />
