...
<div class="olympiad modal-card">
    <h3>
        Олимпиада для студентов CODIFY Teens
    </h3>
    ...
    <p>Это событие создано специально для студентов курсов программирования CODIFY Teens. Здесь вы сможете продемонстрировать свои знания, умения и креативность в программировании.</p>
        <p>Не упустите шанс стать частью этого захватывающего события! Запишитесь на курсы программирования CODIFY Teens уже сегодня и присоединяйтесь к олимпиаде. Давайте вместе создадим что-то удивительное 🚀</p>
    ...
    <form style="position: relative" on:submit={submit}>
        ...
        <button class="button contained">Стать студентом CODIFY Teens</button>
